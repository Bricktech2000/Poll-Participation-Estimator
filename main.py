...
print('more accurate as more values are inputted. Due to the limited amount of information available, the actual number of')
print('people participating can be any integer multiple of the estimated count.')
print('Assumptions:')
